 ...
 *
 * Server lifecycle:
 * AcceptThread.run -> listen -> listen            -> connect -> connected -> AcceptThread.cancel,ConnectedThread.run
 * Client lifecycle:
 * AcceptThread.run -> listen -> ConnectThread.run -> connect -> connected -> AcceptThread.cancel,ConnectedThread.run
 */
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread(boolean secure) {
            ...
            try {
                ...
                LogUtil.e(TAG, "Socket Type: " + mSocketType + "listen() failed", e);
            }
            mmServerSocket = tmp;
        }

        public void run() {
            LogUtil.d(TAG, "Socket Type: " + mSocketType +
            ...
            while (mState != STATE_CONNECTED) {
                try {
                    ...
                    LogUtil.e(TAG, "Socket Type: " + mSocketType + "accept() failed", e);
                    break;
                }
            ...
            LogUtil.i(TAG, "END mAcceptThread, socket Type: " + mSocketType);

        }

        public void cancel() {
            LogUtil.d(TAG, "Socket Type" + mSocketType + "cancel " + this);
            try {
                mmServerSocket.close();
            } catch (IOException e) {
                LogUtil.e(TAG, "Socket Type" + mSocketType + "close() of server failed", e);
            }
        }
    }
