...
public class CircleProgressBar extends View {
    ...
    public CircleProgressBar(Context context, AttributeSet attrs) {
       ...
       mCompleteColor=attributes.getColor(R.styleable.CircleProgressBar_circle_progress_complete_color, DEFAULT_COMPLETE_PAINT_COLOR);
       mUncompleteColor=attributes.getColor(R.styleable.CircleProgressBar_circle_progress_uncomplete_color, DEFAULT_UNCOMPLETE_PAINT_COLOR);
       mTextColor=attributes.getColor(R.styleable.CircleProgressBar_circle_progress_text_color,DEFAULT_TEXT_COLOR);
       mFillBlockRaidus=attributes.getDimension(R.styleable.CircleProgressBar_circle_progress_fill_radius, 0);
       mTextSize=attributes.getDimension(R.styleable.CircleProgressBar_circle_progress_text_size, sptopx(12));
       mFillColor=attributes.getInt(R.styleable.CircleProgressBar_circle_progress_fill_color, DEFAULT_FILL_COLOR);
       setMaxProgress(attributes.getInt(R.styleable.CircleProgressBar_circle_progress_maxprogress, 100));
       setProgress(attributes.getInt(R.styleable.CircleProgressBar_circle_progress_progress, 0));
       isDrawText=attributes.getInt(R.styleable.CircleProgressBar_circle_progress_text_visibility, 1)==1;
       attributes.recycle();  
       initializePainters();  
    }   
   ...
   private void drawCompleteCircle(Canvas canvas){
       ...
       canvas.drawArc(oval, -90, sweepAngle, true,mCompletePaint); //´ÓÈýµãÖÓ¿ªÊ¼
   }    
